const game = {
    ...
    achievements: [
        ...
        new Achievement("True Layer", "Go &delta; 25 times", "&delta;", () => game.layers[3] && game.layers[3].timesReset > 24),
        ...
        new Achievement("Much aleph, much wow", "Reach 1.00e2048 &#8501;", '<span class="aleph">&#8501;</span>', () => game.alephLayer.aleph.gte("1e2048")),
        ...
        new Achievement("Endgame", "Reach layer 1e312 and finish "+mod.primaryName+mod.secondaryName, "Ʊ", () => game.metaLayer.layer.gte("1e312")),
    ],
    secretAchievements: [
        ...
        new Achievement("Meta-Layers 2", "Reach Layer &Omega;<sup>&Omega;</sup> in meta", "&Omega;", () => game.metaLayer.layer.gte(96)),
        new Achievement("Kinetic Energy", "Go &Kappa; 100 times", "&Kappa;", () => game.layers[33] && game.layers[33].timesReset > 99),
        new Achievement("Inf-Infinity", "Reach Layer 1.8e308", "<span style='font-size: 100%;'>Ʊ</span>", () => game.metaLayer.layer.gte("1.8e308")),
        new Achievement("Inf-Infinity + 10 uncentillion", "Reach Layer 1.9e308", "<span style='font-size: 100%;'>Ʊ</span>", () => game.metaLayer.layer.gte("1.9e308")),
